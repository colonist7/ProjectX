...
const User = (props) => {
	const { id, userName, email, getUser, isAuthenticated } = props;

	return <UserShell userName={userName} email={email} id={id} getUser={getUser} isAuthenticated={isAuthenticated} />;
};
